...
public interface ffmpegConstants {
  ...
  public final static int AV_OPT_FLAG_FILTERING_PARAM = (1 << 16);
  ...
  public final static int AV_CODEC_PROP_INTRA_ONLY = (1 << 0);
  public final static int AV_CODEC_PROP_LOSSY = (1 << 1);
  public final static int AV_CODEC_PROP_LOSSLESS = (1 << 2);
  ...
  public final static int CODEC_FLAG2_DROP_FRAME_TIMECODE = 0x00002000;
  ...
  public final static int CODEC_CAP_PARAM_CHANGE = 0x4000;
  public final static int CODEC_CAP_AUTO_THREADS = 0x8000;
  public final static int CODEC_CAP_VARIABLE_FRAME_SIZE = 0x10000;
  public final static int CODEC_CAP_INTRA_ONLY = 0x40000000;
  ...
  public final static int FF_DECODE_ERROR_INVALID_BITSTREAM = 1;
  public final static int FF_DECODE_ERROR_MISSING_REFERENCE = 2;
  ...
  public final static int FF_IDCT_MMI = 5;
  ...
  public final static int FF_PROFILE_AAC_HE = 4;
  public final static int FF_PROFILE_AAC_HE_V2 = 28;
  public final static int FF_PROFILE_AAC_LD = 22;
  public final static int FF_PROFILE_AAC_ELD = 38;
  ...
  public final static int PARSER_FLAG_USE_CODEC_TS = 0x1000;
  ...
  public final static int AVFMT_ALLOW_FLUSH = 0x10000;
  public final static int AVFMT_TS_NONSTRICT = 0x8020000;
  public final static int AVFMT_SEEK_TO_PTS = 0x4000000;
  ...
  public final static int AV_DISPOSITION_ATTACHED_PIC = 0x0400;
  public final static int MAX_STD_TIMEBASES = (60*12+6);
  ...
  public final static int AVFMT_FLAG_NOBUFFER = 0x0040;
